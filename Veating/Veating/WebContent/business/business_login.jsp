		...
		<div class="container clrfix">
			...
			<div class="panel">
				<div class="panel-hd clrfix" id="login-panel-hd">
					<h2 class="title" >商家登录界面</h2>
				</div>
				<div class="panel-bd">
					<form action="/Veating/business_login.action" method="post">
						<div class="form-item">
							<input class="inputbox" name="business.phone" type="text" minlength="5" placeholder="手机号" required="" />
							<div class="g-error-tip hide"></div>
						</div>
						<div class="form-item">
							<input class="inputbox" name="business.password" type="password" minlength="6" maxlength="20" placeholder="密码" required="" />
							<div class="g-error-tip hide"></div>
						</div>
